...
public class TestIntegration {
    ...
    public void testFeedingPetDepletesInventoryAndUpdatesFullness() {
        ...
        GameInventory inventory = new GameInventory("BOB", true);
        ...
        // Feed the pet
        inventory.addFoodItems("Pizza", 1);
        ...
        assertEquals(0, inventory.getFoodItems().get("Pizza"));  // Pizza should be reduced by 10
    }
